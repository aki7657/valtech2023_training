...
public class ArithmeticImpl implements Arithmetic {
	...
	public int div(int a, int b) throws DivideByZeroException {
		if (b == 0) {
			throw new DivideByZeroException("Zero can't be used as a Denominator");
		}
		return a / b;
	}

	public static void main(String[] args) /*throws DivideByZeroException this will remove error but try and error will give a good experience for the user*/ {
